...
class _OpenMapViewState extends State<OpenMapView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _searchBarAnimationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 600));
    ...
    ).animate(CurvedAnimation(parent: _searchBarAnimationController, curve: Curves.easeOutBack));
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                left: 16,
                right: 16,
                child: SlideTransition(position: _searchBarSlideAnimation, child: SearchBarWidget()),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ScaleTransition(
                      scale: _fabScaleAnimation,
                      child: _buildModernFAB(icon: Icons.add_rounded, onPressed: () => _zoomIn(), heroTag: "zoom_in"),
                    ),
                    ...
                    ScaleTransition(
                      scale: _fabScaleAnimation,
                      child: _buildModernFAB(icon: Icons.remove_rounded, onPressed: () => _zoomOut(), heroTag: "zoom_out"),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildCurrentLocationMarker() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.blue.shade300.withOpacity(0.6), blurRadius: 20, spreadRadius: 8)],
      ),
      child: Container(
        ...
        child: Icon(Icons.navigation_rounded, color: Colors.blue.shade600, size: 24),
      ),
    );
  }
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Colors.red.shade300.withOpacity(0.6), blurRadius: 20, spreadRadius: 8)],
            ),
            child: Container(
              margin: const EdgeInsets.all(4),
              decoration: BoxDecoration(
  ...
  Widget _buildModernFAB({required IconData icon, required VoidCallback onPressed, required String heroTag}) {
    return Container(
      width: 56,
      height: 56,
      decoration: BoxDecoration(
